...
<!-- ## Sentiment analysis with BERT models -->

<!-- - Twitter-roberta-base-sentiment is a roBERTa model trained on ~58M tweets and fine-tuned for sentiment analysis (Barbieri et al. 2020) -->
...
<!-- - Distilbert-base-uncased-emotion is a model fine-tuned for detecting emotions in texts, including sadness, joy, love, anger, fear and surprise (Sanh et al., 2019) -->
...
```{r, echo=FALSE, out.width="49%", out.height="20%",fig.show='hold'}
knitr::include_graphics(c("img/Bias_Sentiment_Results.png","img/Bias_Sentiment_Results_Race.png"))
``` 
