...
- An <b>opinion</b> is a sentiment expressed about a specific target (more on this later)
...
## Opinion types
- <span style="color:red">Regular opinions</span>: an evaluation of a target entity, stated either explicitly (direct) or implied through a stated fact (indirect)
...
- <span style="color:red; font-size:22px">But bear in mind</span>
  ...
  - <span style="color:blue">Fact-implied (indirect) opinion</span>: “I bought this car yesterday and it broke today.”
...
- Must consider other features due to…
  - Subtlety of sentiment expression
    - irony 
    (<span style="color:blue">What a great car, it stopped working on the second day.</span>)
...
- <span style="color:red">Limitation</span>: naive summation treats both words as equally important, but "but" signals that the second clause should dominate (see VADER's *conjunction* heuristic, next)
