...
include_graphics("img/pablo.jpg")
```
  <div class="centered">
  **Pablo**
  </div>
...
```
  ...
  **Arjan**
  ...
  <br/>
```{r, echo=FALSE, fig.align='center', out.width="30%"}
include_graphics("img/Jelte.jpg")
```
  <div class="centered">
  **Jelte**
  </div>
...
time <- c("9:00 - 10:30", "", "10:50 – 12:00", "12:00 – 12:30", "", "14:00 – 15:20", "", "15:30 – 16:30", "16:30 – 17:00")
...
- Latest: <a href="https://www.python.org/downloads/">Python 3.12.4</a>

- Follow the tutorial on Python in Google Colab for the Applied Text Mining course: [link](https://robertab.nl/applied_tm/Python_in_Google_Colab_Applied_Text_Mining.html)
...
- Python 3.12.4 documentation
    - <a href="https://www.python.org/doc/">https://www.python.org/doc/</a>
