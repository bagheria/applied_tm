...
<p style="float:left;font-size:18px;">Relevance popularity: A term event model based feature selection scheme for text classification: http://elpub.scix.net/data/works/att/02-28.content.pdf</p>

```{r, echo=FALSE, out.width="65%", fig.align='center'}
include_graphics("img/acc1.jpg")
```

```{r, echo=FALSE, out.width="65%", fig.align='center'}
include_graphics("img/acc2.jpg")
```
