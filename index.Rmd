---
title: "Data Science: Applied Text Mining and Natural Language Processing"
output: 
...
# Intro {.sidebar}
This dashboard covers the course materials for the course [S42: Data Science: Applied Text Mining and Natural Language Processing](https://utrechtsummerschool.nl/courses/data-science/data-science-applied-text-mining-from-foundations-to-advanced).
...
\
Course director: [Robert Bagheri](https://www.uu.nl/staff/ABagheri)

Instructors:

+ [Dong Nguyen](https://www.uu.nl/staff/DPNguyen)\
- [Daniel Anadria](https://www.uu.nl/staff/DAnadria)\
- [Qixiang Fang](https://www.uu.nl/staff/QFang)\
* [Robert Bagheri](https://www.uu.nl/staff/ABagheri)
...
1- Jurafsky, D., Martin, J.H. (2026). Speech and language processing, third edition. Find online chapters [here](https://web.stanford.edu/~jurafsky/slp3/)
...
|            |**[Lunch at the university restaurant at the Educatorium Building](https://www.uu.nl/educatorium)** |           |
|  13:30     | 15:00    | Lecture   |
|            |**Break** |           |
...
This summer you will participate in the "S42: Applied Text Mining and Natural Language Processing, from Foundations to Advanced" course in Utrecht, the Netherlands. To realize a steeper learning curve, we will use some functionality from the Python programming language using Google Colab. The below steps guide you through how to use Python and work on the practicals in this course.
...
- Part 1: Introduction to Text Mining & NLP
    - [Lecture 1](monday/Lectures/lecture 1/Lecture_1.pdf)
...
- Part 3: Feature selection for text data
    - [Lecture 3](tuesday/Lectures/lecture 3/Lecture_3.pdf)
...
- Part 4: Text clustering & topic modeling
    - [Lecture 4](tuesday/Lectures/lecture 4/Lecture_4.pdf)
...
- Part 6: Sentiment analysis
    - [Lecture 6](thursday/Lectures/lecture 8/Lecture_8.html)
    - [Lecture handout 6](thursday/Lectures/lecture 8/Lecture handout_8.pdf)
    - [Practical 6](thursday/Practicals/Practical 8/Impractical 8.html)
    - [Answers practical 6](thursday/Practicals/Practical 8/Practical 8.html)
...
- Part 7: Deep learning for text 1
    - [Lecture 7](wednesday/Lectures/lecture 6/Lecture_6.pdf)
    - [Practical 7](wednesday/Practicals/Practical 6/Impractical 6.html)
    - [Answers practical 7](wednesday/Practicals/Practical 6/Practical 6.html)
    
- Part 8: Deep learning for text 2
    - [Lecture 8](thursday/Lectures/lecture 7/Lecture_7.pdf)
    - [Practical 8](thursday/Practicals/Practical 7/Impractical 7.html)
    - [Answers practical 8](thursday/Practicals/Practical 7/Practical 7.html)
...
- Part 9: LLMs pre-training, prompting, & learning from human feedback
    ...
    - [Practical 9](friday/Practicals/Practical 9/Impractical 9.html)
    - [Answers practical 9](friday/Practicals/Practical 9/Practical 9.html)
...
### Interesting links
- [Paper: Natural Language processing and text mining (turning unstructured data into structured)](https://dspace.library.uu.nl/bitstream/handle/1874/436378/978-3-031-36678-9_5.pdf?sequence=1)
- [Paper: Collaborative Growth: When Large Language Models Meet Sociolinguistics](https://compass.onlinelibrary.wiley.com/doi/pdf/10.1111/lnc3.70010)
- [Paper: Explainability in Practice: A Survey of Explainable NLP Across Various Domains](https://arxiv.org/pdf/2502.00837?)
...
- [Post: Financial times: Generative AI exists because of the transformer](https://ig.ft.com/generative-ai/)
- [Post: What Is ChatGPT Doing … and Why Does It Work?](https://writings.stephenwolfram.com/2023/02/what-is-chatgpt-doing-and-why-does-it-work/)
- [Post: Stone Soup AI](https://simons.berkeley.edu/news/stone-soup-ai)
- [NAVI study on Friendly vs Direct chatbot](https://arxiv.org/abs/2602.17850)
