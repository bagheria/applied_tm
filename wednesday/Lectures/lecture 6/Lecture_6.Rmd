...
<font size="2"> source: http://web.stanford.edu/class/cs224n/ </font>
...
```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/lm6.jpg")
```

##

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/lm7.jpg")
```

##

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/lm8.jpg")
```

##

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/lm9.jpg")
```
...
```{r, echo=FALSE, out.width="80%", fig.align='center'}
include_graphics("img/unroll.jpg")
```  

##

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/rnnlm.jpg")
```

##

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/rnnad.jpg")
```
...
```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/vg.jpg")
```

## Vanishing gradient problem

```{r, echo=FALSE, out.width="100%",  fig.align='center'}
include_graphics("img/vg1.jpg")
```
...
```{r, echo=FALSE, out.width="70%", fig.align='center'}
include_graphics("img/attention.png")
```  
